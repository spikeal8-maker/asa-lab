...
const SOIL_MODEL: ElectricalModelDescriptor = {
...
const PIR_MODEL: ElectricalModelDescriptor = {
...
const SERVO_MOTOR_MODEL: ElectricalModelDescriptor = {
...
const DIGITAL_MULTIMETER_MODEL: ElectricalModelDescriptor = {
...
export function electricalModelFor(component: SchematicComponent): ElectricalModelDescriptor {
  ...
  const base =
    installed && component.componentTypeId === 'soil-moisture-sensor'
      ? SOIL_MODEL
      : installed && component.componentTypeId === 'pir-sensor'
        ? PIR_MODEL
