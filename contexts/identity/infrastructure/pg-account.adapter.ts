...
/**
 * PostgreSQL adapter for the global account identity.
 *
 * Like the rest of the identity context it only calls the narrow SECURITY
 * DEFINER functions: the runtime role has no direct access to the identity
 * tables at all.
 */
