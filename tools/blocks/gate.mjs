...
const focused = [
  [
    ...
    'prettier',
    '--check',
    'apps/api/src/blocks-runtime-capability.ts',
    'apps/api/src/blocks-runtime-capability.spec.ts',
    'apps/api/src/blocks-runtime-authority.ts',
    'apps/api/src/blocks-runtime-authority.spec.ts',
    'apps/api/src/blocks-runtime-config.ts',
    'apps/api/src/blocks-runtime-config.spec.ts',
    'apps/api/src/blocks-runtime-session.ts',
    'apps/api/src/blocks-runtime-session.spec.ts',
    'apps/api/src/blocks-runtime-session-issuer.ts',
    'apps/api/src/blocks-runtime-session.controller.ts',
    'apps/api/src/blocks-runtime-session.controller.spec.ts',
    'apps/api/src/blocks-runtime-request.ts',
    'apps/api/src/blocks-runtime-request.spec.ts',
    'apps/api/src/blocks-runtime-transport.ts',
    'apps/api/src/blocks-runtime-transport.spec.ts',
    'apps/api/src/blocks-runtime-persistence.service.ts',
    'apps/api/src/blocks-runtime.controller.ts',
    'apps/api/src/blocks-runtime.controller.spec.ts',
    'apps/api/src/blocks-runtime-cors.spec.ts',
    'apps/api/src/blocks-runtime-upload-budget.ts',
    'apps/api/src/blocks-runtime-upload-budget.spec.ts',
    'contexts/blocks',
    'apps/web/src/blocks',
  ...
  [
    ...
    'apps/api/src/blocks-runtime-request.spec.ts',
    'apps/api/src/blocks-runtime-transport.spec.ts',
    'apps/api/src/blocks-runtime-persistence.service.spec.ts',
    'apps/api/src/blocks-runtime.controller.spec.ts',
    'apps/api/src/blocks-runtime-cors.spec.ts',
  ],
  [
    ...
    'apps/api/src/blocks-asset-read.spec.ts',
  ...
  [
    ...
    'apps/api/src/blocks-asset-read.ts',
