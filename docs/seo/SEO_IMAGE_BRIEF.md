...
## 1. Что внедрено сейчас

21 августа 2026 года пользователь передал 16 сгенерированных вариантов. Они проверены по
размерам, читаемости, композиции и SHA-256. Файлы `19_08_49.png` и `19_08_43.png` оказались
побайтовыми дубликатами; в продукт вошёл только один из них.

| Файл в продукте | Исходник | Где используется |
| --- | --- | --- |
| `social/asa-lab-og.png` | `18_52_37.png` | fallback-карточка главной, возможностей, FAQ, безопасности и страницы о проекте |
| `social/asa-lab-for-teachers.png` | `18_55_17.png` | страницы для преподавателей и школ |
| `social/asa-lab-block-programming.png` | `19_07_34.png` | блочное программирование |
| `social/asa-lab-drawing.png` | `19_08_08.png` | рисование и визуальные проекты |
| `social/asa-lab-3d-modeling.png` | `19_08_49.png` | 3D-моделирование |
| `social/asa-lab-electronics.png` | `19_14_02.png` | виртуальная электроника |
| `social/asa-lab-chess-checkers.png` | `19_15_04.png` | шахматы и русские шашки |

Все семь файлов приведены к точному размеру 1200 × 630 px без изменения исходников в
Downloads. Они подключены через Open Graph, Twitter Card и JSON-LD. Автоматическая SEO-проверка
контролирует наличие, PNG-сигнатуру, размеры, предел 1,5 MiB и отсутствие текстовых/EXIF-чанков.

Отдельная hero-картинка намеренно не загружается в интерфейсе: для индексации она не нужна, а
подключение тяжёлого растра над сгибом ухудшило бы LCP. Варианты без текста сохранены у владельца и
могут быть использованы позднее как контентные иллюстрации после WebP/AVIF-оптимизации.
...
- PNG для social cards желательно до 800 KB; для этой серии принят предел 1,5 MiB, чтобы не
  размывать русские заголовки дополнительным сжатием;
