...
## Latest-main and exact CI addendum

Final read-only check found main advanced to `48770100f58e0a4383ee0695802c5daaf5204d31` while CI ran. Scratch protocol and Checkers CK-105 changed 17 paths outside this amendment and E1's overlap set; main now has 151 changed paths from b963ef8. A new diagnostic merge retained 4 overlaps, 3 textual conflicts and 30 migrations. The current.yaml dated observation and convergence plan were refreshed without integrating product code. Initial snapshot values in section A intentionally remain historical.
