...
физическими концами выводов на расстоянии 10,16 мм. Каталожный поворот для обоих
корпусов одинаков (`90°`), поэтому вставка и смена варианта сохраняют вертикальную
ориентацию, а электрические точки совпадают с концами металлических выводов.
Отдельная упрощённая runtime-перерисовка DO-35 запрещена. Нулевой ток сам по себе
