...
```text
1. Exactly the requested outcome?
2. Every path justified by mapped ownership/dependencies?
3. No unrequested behaviour?
4. Neighbour/security/persistence boundaries preserved?
5. Acceptance proved by tests?
6. No duplicate/dead code or second source of truth?
7. Source/test ownership changes reflected in the subsystem card?
8. No future task/sub-slice started?
9. Concrete residual risks stated?
```
