...
по принятому [интегрированному ТЗ V1.2](ASA_INTEGRATED_IMPLEMENTATION_SPEC.md).
...
Принятое уточнение V1.2 §4.7: `first` выбирает минимальный
...
Принятые интеграционные границы V1.2: physical personal scope и bilateral linking
