...
| Принятый порядок реализации | [`ASA_LEARNING_AGENT_WORK_QUEUE.md`](ASA_LEARNING_AGENT_WORK_QUEUE.md), единый индекс Э1–Э6 интегрированного ТЗ V1.2, только вместе с текущим разрешённым scope |
