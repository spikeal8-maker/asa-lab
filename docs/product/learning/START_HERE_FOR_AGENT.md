...
| Принятый порядок реализации | [`ASA_LEARNING_AGENT_WORK_QUEUE.md`](ASA_LEARNING_AGENT_WORK_QUEUE.md), единый индекс Э1–Э6 интегрированного ТЗ V1.4, только вместе с текущим разрешённым scope |
| Интеграция и обязательная полнота этапа | [`ASA_INTEGRATED_IMPLEMENTATION_SPEC.md`](../ASA_INTEGRATED_IMPLEMENTATION_SPEC.md), применимые разделы и критерии |
