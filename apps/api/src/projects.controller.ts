...
export class ProjectsController {
  ...
  /**
   * Who the request acts as. A principal always exists; the tenant-scoped user
   * exists only in a workspace that still has one.
   */
  private static actorOf(context: ActiveContext): { principalId: string; userId: string | null } {
