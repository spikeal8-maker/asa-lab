 ...
 *
 * Identity controls stay in ASA Web while project saving is owned by Scratch's
 * upstream ProjectSaverHOC. This component never forwards account data or cookies
 * into the Scratch runtime. The
