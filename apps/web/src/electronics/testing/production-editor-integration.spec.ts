...
const ACTIVE_PHYSICAL_SIZE_MM = {
  ...
  'battery-holder-aa-1': [25.5808, 76.2],
  'battery-holder-aa-2': [43.8399, 76.2],
  'battery-holder-aa-3': [62.0989, 76.2],
  'battery-holder-aa-4': [80.358, 76.2],
  'battery-holder-aa-6': [116.8762, 76.2],
  'battery-holder-aa-8': [153.3943, 76.2],
  'diode-do35': [13.5, 4.5],
  'diode-do41': [15, 5.25],
  'rgb-led': [8.75, 10.125],
