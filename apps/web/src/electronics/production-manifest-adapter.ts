...
const COMPONENT_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  gearmotor: 'Двигатель постоянного тока со встроенным редуктором.',
  ...
  'soil-moisture-sensor':
    'Трёхвыводный датчик влажности почвы. Размещение и соединение доступны; математическая модель готовится.',
  'ultrasonic-sensor':
...
function pinLabel(componentId: string, pinId: string): string {
  ...
  const labels: Readonly<Record<string, string>> = {
    ...
    anode: 'Анод',
    cathode: 'Катод',
    'terminal-1': 'Крайний вывод 1',
    'terminal-2': 'Крайний вывод 2',
    wiper: 'Движок (регулируемый вывод)',
    L1: 'Клемма 1',
    L2: 'Клемма 2',
    common: 'Общий',
    'throw-left': 'Клемма 1',
