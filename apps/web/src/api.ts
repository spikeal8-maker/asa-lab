...
export interface ComponentResult {
  ...
  readonly sensorOutputRegion?: 'regulated' | 'current-limit' | 'high-impedance' | 'divider';
  ...
  signalWaveform?: 'sine' | 'square' | 'triangle';
  signalFrequencyHz?: number;
  signalAmplitudeVpp?: number;
  signalOffsetVolt?: number;
  signalOutputEnabled?: boolean;
  signalInstantaneousVolt?: number;
  oscilloscopeInputResistanceOhm?: number;
  oscilloscopeInputVoltageVolt?: number;
  oscilloscopeVoltsPerDivision?: number;
  oscilloscopeTimePerDivisionMs?: number;
  oscilloscopeTriggerLevelVolt?: number;
  oscilloscopeFrequencyHz?: number;
  oscilloscopeAmplitudeVpp?: number;
  oscilloscopeTrace?: { timeMs: number; voltageVolt: number }[];
