    ...
    >
      <section className="portal-hero">
        <div>
          ...
          <h1>Мои классы</h1>
          <p>
            Управляйте учениками, проектами и будущими заданиями отдельно от личной мастерской.
          </p>
        </div>
        <button
          ref={createButtonRef}
      ...
      {modalOpen ? (
        <CreateClassroomModal
          ...
          onCreated={(classroom, created) => {
            setModalOpen(false);
            setNotice(
              created ? `Класс «${classroom.title}» создан.` : `Класс «${classroom.title}» уже существует.`,
            );
