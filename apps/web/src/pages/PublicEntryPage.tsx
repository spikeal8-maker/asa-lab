...
import { isClassCodeEntryEnabled } from '../feature-flags';

/**
 * Public entry: the intentions a visitor arrives with, in their own words.
 *
      ...
      <main className="entry-card">
        ...
        <div className="entry-actions">
          ...
          <span className="entry-action-hint">
            Личное пространство для своих проектов. Педагогические возможности включаются позже.
          </span>

          {isClassCodeEntryEnabled() ? (
            <>
              <button
                type="button"
                className="btn-secondary entry-action"
              ...
              <span className="entry-action-hint">
                Для ученика, которому педагог выдал код класса.
              </span>
            </>
          ) : null}
        </div>
