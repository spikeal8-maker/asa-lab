        ...
        <section className="public-home-hero" aria-labelledby="public-home-title">
          <div className="public-home-hero-copy">
            ...
            <p className="public-home-hero-lead">
              ASA Lab — браузерная среда, где можно моделировать, собирать схемы, программировать,
              создавать собственные цифровые проекты и смотреть, что делают другие. Инструменты,
              проекты, авторы и сообщество связаны в одной экосистеме.
            </p>
            ...
            {capabilities.map((capability) => (
              <article className="public-home-capability" key={capability.title}>
                ...
                <div className="public-home-capability-copy">
                  {capability.status ? (
                    <span className="public-home-card-status">{capability.status}</span>
                  ) : null}
        ...
        >
          ...
          <div className="public-home-development-grid">
            <article>
              ...
              <p>
                Более точное инженерное моделирование с привычной логикой профессиональных
                CAD-систем. КОМПАС-3D остаётся ориентиром для отдельных российских сценариев, а не
                определением бренда.
              </p>
            </article>
            <article>
            ...
            <article>
              ...
              <p>
                Быстрые заготовки и результаты, которые можно продолжить редактировать в проекте.
              </p>
            </article>
            <article>
              <span className="public-home-status">Развивается</span>
        ...
        <section className="public-home-section public-home-use" aria-labelledby="use-title">
          ...
          <div className="public-home-use-grid">
            <article>
              ...
              <h3>Для себя</h3>
              <p>
                Хобби, личная идея, эксперимент, прототип или просто желание попробовать новый
                инструмент.
              </p>
            </article>
            <article>
              ...
              <h3>С сообществом</h3>
              <p>
                Смотрите опубликованные работы, реагируйте, находите идеи и показывайте собственные
                проекты.
              </p>
            </article>
            <article>
        ...
        >
          <div className="public-home-about-copy">
            ...
            <p>
              ...
              инструменты, проекты, авторов, публикации и развитие идей, чтобы человеку не
              приходилось собирать весь процесс из несвязанных сервисов.
            </p>
            <p>
