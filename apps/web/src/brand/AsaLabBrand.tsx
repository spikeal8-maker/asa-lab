 ...
 *
 * The laboratory flask forms an abstract letter A. Three amber nodes represent
 * the creator, the project and the classroom/module network. The geometry is
 * deliberately unrelated to the previous four-tile reference-product mark.
 */
