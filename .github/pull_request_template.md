...
- [ ] Я прочитал(а) и принимаю
      [`CLA.md`](https://github.com/spikeal8-maker/asa-lab/blob/main/CLA.md)
      версии 1.0 для всех оригинальных программных изменений в этом Pull
      Request.
- [ ] Я имею право предоставить указанные в CLA и `AGPL-3.0-only` лицензии, а
      вклад не содержит чужого кода, данных, бренда или материалов без
      совместимого разрешения.

Если CLA неприменим, потому что PR не содержит программного или иного
охраняемого авторским правом вклада, укажите здесь причину:
