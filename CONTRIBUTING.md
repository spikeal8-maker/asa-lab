...
Программный вклад принимается только при явном согласии автора с
[`CLA.md`](CLA.md). Автор сохраняет авторские права, лицензирует вклад
пользователям по `AGPL-3.0-only` и предоставляет владельцу проекта права,
перечисленные в CLA, включая право отдельного лицензирования. Автор
подтверждает право сделать это и отсутствие во вкладе несовместимого кода,
данных, бренда, учебного контента или графики.

Чтобы зафиксировать согласие, автор Pull Request должен отметить пункт CLA в
шаблоне PR. Вклады от организации принимаются только от лица, имеющего право
предоставить указанные лицензии от её имени. Если автор не может принять CLA,
он может открыть Issue с предложением, но код не будет объединён.

Принятие программного вклада не предоставляет автору прав на название и знаки ASA Lab
или исключённые материалы. Перед Pull Request прочитайте
[`LICENSING.md`](LICENSING.md), [`TRADEMARKS.md`](TRADEMARKS.md) и
