...
Если отдельное письменное соглашение не заключено, отправляя вклад, автор
соглашается лицензировать его на условиях `AGPL-3.0-only` для той части ASA
Lab, к которой он относится. Автор подтверждает право сделать это и отсутствие
в нём несовместимого кода, данных, бренда, учебного контента или графики.

Принятие программного вклада не предоставляет прав на название и знаки ASA Lab
