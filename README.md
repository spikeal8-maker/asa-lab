...
цифровая лаборатория для школы. Ученик создаёт 3D-модели, собирает электронные
схемы, изучает шахматы и русские шашки, а педагог организует классы, выдаёт
задания и видит реальный путь решения. Блочное программирование и рисование
...
- [блочное программирование](https://asa-lab.ru/features/block-programming/) —
  будущая визуальная среда алгоритмов и проектных заданий;
- [рисование и визуальные проекты](https://asa-lab.ru/features/drawing/) —
  будущая среда работы с формой, цветом и цифровыми материалами;
- расширение учебных сценариев, обратной связи, доступности, мобильных режимов
  и эксплуатационной готовности активных модулей.
