...
> От идеи к работающему проекту.

**[ASA Lab](https://asa-lab.ru/)** — цифровая лаборатория для проектирования и
изобретений. Пользователь создаёт 3D-модели, собирает электронные схемы,
программирует, рисует и чертит, исследует шахматы и русские шашки, сохраняет
собственные проекты и улучшает найденные решения.

Классы и задания дополняют проектный контур, когда ASA Lab используется на
занятии, в кружке или в команде. Они помогают организовать работу, но ядром
продукта остаются собственный проект, эксперимент и путь от идеи до результата.
...
- [блочное программирование](https://asa-lab.ru/features/block-programming/) —
  визуальные алгоритмы, условия, циклы и переменные;
- [рисование и черчение](https://asa-lab.ru/features/drawing/) — линии, формы,
  эскизы, схемы и собственные визуальные проекты;
...
Продукт продолжает развивать проектные сценарии, обратную связь, доступность,
мобильные режимы и эксплуатационную готовность модулей.
